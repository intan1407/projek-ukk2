...
<head>
  ...
  <title>GuestBook App | Buku Tamu Online </title>
...
<div class="login-box">
  ...
  <div class="login-box-body">
    <div class="text-center"><img src="<?php echo base_url().'assets/images/logo_gb.png'?>"></div>
    <h3 class="text-center login-box-msg"><b>GuestBook</b></h3>
    ...
    <!-- /.social-auth-links -->
    <hr/>
    <p><center>Copyright &copy; <?php echo date('Y');?> All Right Reserved</center></p>
  </div>
  <!-- /.login-box-body -->
</div>
<!-- /.login-box -->
